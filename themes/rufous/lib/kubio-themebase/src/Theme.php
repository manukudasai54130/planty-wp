...
class Theme extends ThemeBase {
	...
	public function addKubioOnboarding() {
		...
		if ( $notice_disabled || $kubio_enabled ) {
			return;
		}
					...
					<div class="kubio-onboarding__wrapper__content">
						<label>
							...
							<div class="radio-card">
								...
								<div class="radio-card__image-container">
									<img src="<?php echo rufous_theme()->getThemeResource( 'images/theme-base/web-layout.png' ); ?>" alt="web-layout" draggable="false">
								</div>
								<span>
						...
						<label>
							...
							<div class="radio-card">
								...
								<div class="radio-card__image-container">
									<img src="<?php echo rufous_theme()->getThemeResource( 'images/theme-base/blog-layout.png' ); ?>" alt="blog-layout" draggable="false" >
								</div>
								<span>
